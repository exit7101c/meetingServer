...
SVGElement.prototype = {
	...
	/**
	 * Build an SVG gradient out of a config JavaScript configuration object
	 */
...
Chart.prototype = {
	...
	firstRender: function () {
		...
		// Set the config chart properties (mainly invert) from the given series
...
Point.prototype = {
	 ...
	 *
	 * @return {String} A string to be concatenated in to the config tooltip text
	 */
...
Series.prototype = {
	...
	setData: function (data, redraw, animation, updatePoints) {
		...
		if (updatePoints !== false && dataLength && oldDataLength === dataLength && !series.cropped && !series.hasGroupedData) {
			...
			// Forgetting to cast strings to numbers is a config caveat when handling CSV or JSON
			if (isString(yData[0])) {
				error(14, true);
			}
...
extend(Axis.prototype, {
	 ...
	 * config point interval, in this case days.
	 *
...
var DATA_GROUPING = 'dataGrouping',
	...
	specificOptions = { // extends config options
		line: {},
		spline: {},
		area: {},
		areaspline: {},
