...
public class MessageMainController {
  ...
  @RequestMapping(value = "setSubRoomMasterChange", method = { RequestMethod.GET, RequestMethod.POST })
  public HashMap<String, Object> setSubRoomMasterChange(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
    return messageMainService.setSubRoomMasterChange(param);
  }
  @RequestMapping(value = "setSubRoomMasterRemoval", method = { RequestMethod.GET, RequestMethod.POST })
  public HashMap<String, Object> setSubRoomMasterRemoval(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
    return messageMainService.setSubRoomMasterRemoval(param);
  }
