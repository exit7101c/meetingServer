...
public class CommunityController {
    ...
    @RequestMapping(value = "getCommunityFeedList", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> getCommunityFeedList(@RequestParam HashMap<String, Object> param) throws Exception {
        return communityService.getCommunityFeedList(param);
    }
    ...
    @RequestMapping(value = "setAdminHideCommunity", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> setAdminHideCommunity(@RequestParam HashMap<String, Object> param) throws Exception {
        return communityService.setAdminHideCommunity(param);
    }
    ...
    public HashMap<String, Object> communityDropCheck(@RequestParam HashMap<String, Object> param) throws Exception {
        int articleId = 0;
        // Homepage.vue 에서 best topic 클릭 시 500에러 발생확인
        // Homepage.vue 에서는 articleId, community.vue에서는 articleKey로 받아서 int파싱할 때 에러나면 decoding하도록 수정
        try {
            articleId = Integer.parseInt(param.get("articleKey").toString());
        } catch (NumberFormatException e) {
            articleId = Integer.parseInt(commonService.getDecoding(param.get("articleKey").toString()));
        }
