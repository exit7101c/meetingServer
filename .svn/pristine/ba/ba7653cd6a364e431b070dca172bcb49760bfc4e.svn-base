...
public class HomeController {
    ...
    @RequestMapping(value = "getHotpeopleState", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public List<HashMap<String, Object>> getHotpeopleState(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
        return homeService.getHotpeopleState(param);
    }
    ...
    public HashMap<String, Object> getHomeItemListAll(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
        ...
        //홈 HOT PEOPLE 사용자 목록
        if(param.get("stateCd") != null && !param.get("stateCd").toString().equals("")){
            HashMap<String, Object> seasonTimeMap = exqueryService.selectOne("cronies.app.home.getSeasonStartEndTime", param);
            if(seasonTimeMap != null){
                param.put("seasonStartTime", seasonTimeMap.get("seasonStartTime"));
                param.put("seasonEndTime", seasonTimeMap.get("seasonEndTime"));
            }
        }
