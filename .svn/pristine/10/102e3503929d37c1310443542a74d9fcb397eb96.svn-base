...
public class OpenChatController {
    ...
    @RequestMapping(value = "getMyOpenChatList", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> getMyOpenChatList(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
        return openChatService.getMyOpenChatList(param);
    }
    ...
    @RequestMapping(value = "getOpenChatSendMessage", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> getOpenChatSendMessage(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
        return openChatService.getOpenChatSendMessage(param);
    }

    @RequestMapping(value = "updateAboutMeMessage", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> updateAboutMeMessage(@RequestParam HashMap<String, Object> param, ModelMap model) throws Exception {
        return openChatService.updateAboutMeMessage(param);
    }
