...
public class ContestServiceImpl implements ContestService {
    ...
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    public HashMap<String, Object> getVoteHis(HashMap<String, Object> param) throws Exception {
        HashMap<String, Object> resultMap = new HashMap<String, Object>();

        try {
            resultMap = exqueryService.selectPagingList("cronies.app.contest.getVoteHisList", param,
            ...
            resultMap.put("successYn", "N");
            resultMap.put("message", "리스트 조회도중 에러가 발생하였습니다.");
        }
