...
public class AlarmServiceImpl implements AlarmService {
    ...
    public HashMap<String, Object> getAlarmOpenChatDel(HashMap<String, Object> param) throws Exception {
        ...
        if(returnMap.get("delYn").toString().equals("Y")){
            resultMap.put("message", "이미 삭제된 소모임입니다.");
        }
        return resultMap;
    }

    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    public HashMap<String, Object> getAlarmOpenChatMeetDelCheck(HashMap<String, Object> param) throws Exception {
        HashMap<String, Object> resultMap = new HashMap<String, Object>();
        HashMap<String, Object> returnMap = new HashMap<String, Object>();
        param.put("meetId", commonService.getDecoding(param.get("openChatKey").toString()));
        returnMap = exqueryService.selectOne("cronies.app.alarm.getAlarmOpenChatMeetDelCheck", param);
        resultMap.put("delYn", returnMap.get("delYn"));
        if(returnMap.get("delYn").toString().equals("Y")){
