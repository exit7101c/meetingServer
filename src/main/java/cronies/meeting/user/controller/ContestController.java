...
public class ContestController {
    ...
    **/
     ...
     * 콘테스트 투표 리스트 상세조회
     **/
    @RequestMapping(value = "getVoteHis", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> getVoteHis(@RequestParam HashMap<String, Object> param) throws Exception {
        return contestService.getVoteHis(param);
    }
