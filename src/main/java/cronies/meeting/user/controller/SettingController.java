...
public class SettingController {
    ...
    @RequestMapping(value = "getMyBadgeInfo", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public List<HashMap<String, Object>> getMyBadgeInfo(@RequestParam HashMap<String, Object> param) throws Exception {
        return settingService.getMyBadgeInfo(param);
    }

    @RequestMapping(value = "getMyBadgeList", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public List<HashMap<String, Object>> getMyBadgeList(@RequestParam HashMap<String, Object> param) throws Exception {
        return settingService.getMyBadgeList(param);
    }

    @RequestMapping(value = "getBadgeSituation", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public HashMap<String, Object> getBadgeSituation(@RequestParam HashMap<String, Object> param) throws Exception {
        return settingService.getBadgeSituation(param);
    }

    @RequestMapping(value = "getUserBadgeInfo", method = { RequestMethod.GET, RequestMethod.POST })
    @ResponseBody
    public List<HashMap<String, Object>> getUserBadgeInfo(@RequestParam HashMap<String, Object> param) throws Exception {
        return settingService.getUserBadgeInfo(param);
    }
